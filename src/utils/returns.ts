...
const PRICE_DISCOVERY_START_TIMESTAMP = 1691760974
...
function formatPricesForEarlyTimestamps(position): Position {
  if (position.timestamp < PRICE_DISCOVERY_START_TIMESTAMP) {
    ...
    // WETH price
    if (position.pair?.token0.id === '0x42f3f703c0a15a4ad920cfdb4b87265458cb4325') {
      position.token0PriceUSD = 203
    }
    if (position.pair?.token1.id === '0x42f3f703c0a15a4ad920cfdb4b87265458cb4325') {
